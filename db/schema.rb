...
ActiveRecord::Schema[8.1].define(version: 2025_11_09_025127) do
  create_table "conversations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["initiator_id", "created_at"], name: "index_conversations_on_initiator_id_and_created_at"
  ...
  create_table "expert_assignments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["conversation_id", "expert_id"], name: "index_expert_assignments_on_conversation_id_and_expert_id"
